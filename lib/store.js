// Minimal Redis-like store with two backends:
//  - Upstash Redis when its REST env vars are configured (production on Vercel)
//  - In-memory fallback for local dev (single process only)
//
// The Vercel Marketplace "Upstash for Redis" integration injects either
// KV_REST_API_URL/KV_REST_API_TOKEN or UPSTASH_REDIS_REST_URL/TOKEN. We accept both.
//
// Only the small subset of list/string ops this app needs is implemented.
